...
public class HelloTest {
    ...
    public void testSayHello() {
        ...
        assertThat(os.toString(), is(equalTo(String.format("%s%s", Hello.helloMsg, System.lineSeparator()))));
    }
    ...
    public void testSayHelloAFewTimes() {
        ...
        String goal = String.format("%1$s%2$s%1$s%2$s%1$s%2$s", Hello.helloMsg, System.lineSeparator());
